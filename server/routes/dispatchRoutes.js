...
const { getDispatch, createDispatch, updateDispatch, deleteDispatch, getDispatchById } = require("../controllers/dispatchController");
const { verifyToken } = require("../middlewares/AuthMiddleware");
const router = express.Router();


router.get("/get",verifyToken, getDispatch);
router.get("/get/:dispatchId",verifyToken, getDispatchById);
